...
namespace ProjMVC.Controllers
{
    public class PlayListController : Controller
    {
        ...
        private readonly Uri Userrel = new Uri("https://localhost:44325/api/PlayLists");
        string token;
        // GET: National
        ...
        public async Task<ActionResult> Edit(int id)
        {
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                // make a request
                HttpResponseMessage respondMessage = await client.GetAsync("/api/Playlists/" + id);
        ...
        public async Task<ActionResult> Edit(PlayListVM playListVM)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                //make request
                HttpResponseMessage response = await client.PutAsync("", byteContect);
